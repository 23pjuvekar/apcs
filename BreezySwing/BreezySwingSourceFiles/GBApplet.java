 ...
 * width and height. Connects the panel to this GBApplet, for event handling with buttons and list boxes.
 * @param  row The beginning row (starting from 1) of the window's grid in which the GBPanel is displayed.
 * @param  col The beginning column (starting from 1) of the window's grid in which the GBPanel is displayed.
 * @param  width The number of columns of the window's grid occupied by the GBPanel.
 * @param  height The number of rows of the window's grid occupied by the GBPanel.
 * @return the GBPanel.
 */
